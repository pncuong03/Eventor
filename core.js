!function(e) {
    ...
    function o(n) {
        ...
        e[n].call(t.exports, t, t.exports, o),
        t.l = !0,
        t)).exports
    }
    o.m = e,
    ...
    function e(n, t) {
        return function(n) {
            ...
            if (null != e) {
                var r, o, i = [], a = !0, u = !1;
                try {
                    for (e = e.call(n); !(a = (r = e.next()).done) && (i.push(r.value),
                    !t || i.length !== t); a = !0)
                        ;
                } catch (n) {
                    u = !0,
            ...
            var e;
            if (n)
                return "string" == typeof n ? r(n, t) : "Map" === (e = "Object" === (e = Object.prototype.toString.call(n).slice(8, -1)) && n.constructor ? n.constructor.name : e) || "Set" === e ? Array.from(n) : "Arguments" === e || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(e) ? r(n, t) : void 0
        }(n, t) || function() {
...
, function(n, t, e) {
    ...
    o = e(0),
    i = e(2),
    (e = r.createElement("script")).async = !0,
    i.setVersion("b4887131"),
    o.isInRampPercentage(o.LIST.SEND_LOGS.chance) && (e.onerror = function() {
        i.error("Failed to load ".concat("b4887131"), new Error("failed to load main.js"))
    }
    ),
    e.src = "https://s.pinimg.com/ct/lib/main.b4887131.js",
    (o = r.getElementsByTagName("script")[0]).parentNode.insertBefore(e, o)
}
, function(n, t, e) {
    var r = e(0)
      , o = {}
    ...
    o.v = function(n) {
        ...
        ,
        t.open("POST", "https://ct.pinterest.com/stats/", !1),
    ...
    o.error = function(n, t) {
        ...
        t.hasOwnProperty("stack") ? e.log += "[".concat(t.stack, "]") : e.log += "[".concat(t.message, "]"),
        e.version = i,
        100 * Math.random() < (r.LIST.SEND_LOGS.chance || 0) && o.v(e)
    }
    ,
    n.exports = o
}
