    ...
    const e = $("*[data-analytics-page-id]").data("analyticsPageId")
      , a = (a,n)=>{
        const t = $(a).closest("[data-analytics-element-id]")
          ...
          , d = $(t.parents("[data-analytics-section-id]")).data("analyticsSectionId")
      ...
      , n = (e,n)=>{
        const {elementId: t, elementLabel: o, elementPosition: i, eventType: d, pageId: s, sectionId: l, sectionLabel: c, sectionPosition: m, tagName: r} = a(e, n);
