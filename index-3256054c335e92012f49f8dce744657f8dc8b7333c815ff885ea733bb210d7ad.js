!function(e, t) {
    ...
    function u(e, t, n) {
        ...
        if (void 0 === n && 1 === e.nodeType)
            if (r = "data-" + t.replace(_e, "-$1").toLowerCase(),
    ...
    function w(e) {
        var t = X
          , n = We[e];
        return n || ("none" !== (n = _(e, t)) && n || ((t = (Ie = (Ie || K("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement))[0].contentDocument).write(),
        t.close(),
        n = _(e, t),
        Ie.detach()),
        We[e] = n),
    ...
    function b(e, t, n) {
        ...
        return (n = n || $e(e)) && (s = n.getPropertyValue(t) || n[t]),
        n && ("" !== s || K.contains(e.ownerDocument, e) || (s = K.style(e, t)),
        Ue.test(s) && qe.test(t) && (r = a.width,
        i = a.minWidth,
        o = a.maxWidth,
    ...
    function T(e, t, n, r, i) {
        for (var o = n === (r ? "border" : "content") ? 4 : "width" === t ? 1 : 0, s = 0; o < 4; o += 2)
            "margin" === n && (s += K.css(e, n + ke[o], !0, i)),
            r ? ("content" === n && (s -= K.css(e, "padding" + ke[o], !0, i)),
            "margin" !== n && (s -= K.css(e, "border" + ke[o] + "Width", !0, i))) : (s += K.css(e, "padding" + ke[o], !0, i),
            "padding" !== n && (s += K.css(e, "border" + ke[o] + "Width", !0, i)));
        return s
    }
    function D(e, t, n) {
        var r = !0
    ...
    function C(e, t) {
        for (var n, r, i, o = [], s = 0, a = e.length; s < a; s++)
            (r = e[s]).style && (o[s] = ge.get(r, "olddisplay"),
            n = r.style.display,
            t ? (o[s] || "none" !== n || (r.style.display = ""),
            "" === r.style.display && Se(r) && (o[s] = ge.access(r, "olddisplay", w(r.nodeName)))) : (i = Se(r),
    ...
    function E(e, t, n) {
        var r, i, o, s, a, u, l, c = this, f = {}, h = e.style, d = e.nodeType && Se(e), p = ge.get(e, "fxshow");
        ...
        "inline" === ("none" === (l = K.css(e, "display")) ? ge.get(e, "olddisplay") || w(e.nodeName) : l) && "none" === K.css(e, "float") && (h.display = "inline-block")),
        ...
        if (K.isEmptyObject(f))
            "inline" === ("none" === l ? w(e.nodeName) : l) && (h.display = l);
        else
            for (r in p ? "hidden"in p && (d = p.hidden) : p = ge.access(e, "fxshow", {}),
            o && (p.hidden = !d),
            d ? K(e).show() : c.done((function() {
                K(e).hide()
            }
            )),
            c.done((function() {
    ...
    function j(e, t, n) {
        var r, i, o = 0, s = nt.length, a = K.Deferred().always((function() {
            delete u.elem
        }
        )), u = function() {
            if (i)
                return !1;
            for (var t = Xe || N(), n = Math.max(0, l.startTime + l.duration - t), r = 1 - (n / l.duration || 0), o = 0, s = l.tweens.length; o < s; o++)
                l.tweens[o].run(r);
    ...
    K.extend = K.fn.extend = function() {
        ...
        a--); a < u; a++)
            if (null != (e = arguments[a]))
                for (t in e)
                    n = s[t],
                    s !== (r = e[t]) && (l && r && (K.isPlainObject(r) || (i = K.isArray(r))) ? (i ? (i = !1,
                    o = n && K.isArray(n) ? n : []) : o = n && K.isPlainObject(n) ? n : {},
                    s[t] = K.extend(l, o, r)) : void 0 !== r && (s[t] = r));
        return s
    }
    ,
    K.extend({
        ...
        globalEval: function(e) {
            var t, n = eval;
            (e = K.trim(e)) && (1 === e.indexOf("use strict") ? ((t = X.createElement("script")).text = e,
    ...
    var ie = function(e) {
        function t(e, t, n, r) {
            ...
            if ((t ? t.ownerDocument || t : I) !== E && A(t),
            n = n || [],
            !e || "string" != typeof e)
                return n;
            ...
            if (j && !r) {
                    ...
                    if (s = i[1]) {
                        if (9 === a) {
                            ...
                            if (o.id === s)
                                return n.push(o),
                                n
                        } else if (t.ownerDocument && (o = t.ownerDocument.getElementById(s)) && H(t, o) && o.id === s)
                            return n.push(o),
                            n
                    } else {
                        if (i[2])
                ...
                if (b.qsa && (!P || !P.test(e))) {
                    ...
                    1 === a && "object" !== t.nodeName.toLowerCase()) {
                        for (l = T(e),
                        (f = t.getAttribute("id")) ? d = f.replace(we, "\\$&") : t.setAttribute("id", d),
                        d = "[id='" + d + "'] ",
                        u = l.length; u--; )
                            l[u] = d + h(l[u]);
        ...
        function y(e, t, n, i, o, s) {
            ...
            o && !o[F] && (o = y(o, s)),
            r((function(r, s, a, u) {
                var l, c, f, h = [], d = [], p = s.length, y = r || m(t || "*", a.nodeType ? [a] : a, []), v = !e || !r && t ? y : g(y, h, e, a, u), _ = n ? o || (r ? e : p || i) ? [] : s : v;
                if (n && n(v, _, a, u),
                i)
                    for (l = g(_, d),
                    i(l, [], a, u),
                ...
                if (r) {
                    if (o || e) {
                        ...
                        for (c = _.length; c--; )
                            (f = _[c]) && (l = o ? te.call(r, f) : h[c]) > -1 && (r[l] = !(s[l] = f))
                    }
                } else
                    _ = g(_ === s ? _.splice(p, _.length) : _),
                    o ? o(null, s, _, u) : K.apply(s, _)
            }
            ))
        }
        function v(e) {
            for (var t, n, r, i = e.length, o = x.relative[e[0].type], s = o || x.relative[" "], a = o ? 1 : 0, u = d((function(e) {
                ...
                return !o && (r || n !== M) || ((t = n).nodeType ? u(e, n, r) : l(e, n, r))
            }
            ]; a < i; a++)
        ...
        function _(e, n) {
            var i = n.length > 0
              ...
              , s = function(r, s, a, u, l) {
                var c, f, h, d = 0, p = "0", m = r && [], y = [], v = M, _ = r || o && x.find.TAG("*", l), w = W += null == v ? 1 : Math.random() || .1, b = _.length;
                for (l && (M = s !== E && s); p !== b && null != (c = _[p]); p++) {
                    if (o && c) {
                        for (f = 0; h = e[f++]; )
                            if (h(c, s, a)) {
                                u.push(c);
        ...
        var w, b, x, k, S, T, D, C, M, N, O, A, E, Y, j, P, R, L, H, F = "sizzle" + -new Date, I = e.document, W = 0, q = 0, U = n(), $ = n(), V = n(), z = function(e, t) {
            return e === t && (O = !0),
            0
        }, G = "undefined", B = 1 << 31, Q = {}.hasOwnProperty, Z = [], X = Z.pop, J = Z.push, K = Z.push, ee = Z.slice, te = Z.indexOf || function(e) {
            for (var t = 0, n = this.length; t < n; t++)
                if (this[t] === e)
                    return t;
            return -1
        }
        , ne = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", re = "[\\x20\\t\\r\\n\\f]", ie = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+", oe = ie.replace("w", "w#"), se = "\\[" + re + "*(" + ie + ")(?:" + re + "*([*^$|!~]?=)" + re + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + oe + "))|)" + re + "*\\]", ae = ":(" + ie + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + se + ")*)|.*)\\)|)", ue = new RegExp("^" + re + "+|((?:^|[^\\\\])(?:\\\\.)*)" + re + "+$","g"), le = new RegExp("^" + re + "*," + re + "*"), ce = new RegExp("^" + re + "*([>+~]|" + re + ")" + re + "*"), fe = new RegExp("=" + re + "*([^\\]'\"]*?)" + re + "*\\]","g"), he = new RegExp(ae), de = new RegExp("^" + oe + "$"), pe = {
            ID: new RegExp("^#(" + ie + ")"),
            CLASS: new RegExp("^\\.(" + ie + ")"),
        ...
        }, me = /^(?:input|select|textarea|button)$/i, ge = /^h\d$/i, ye = /^[^{]+\{\s*\[native \w/, ve = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, _e = /[+~]/, we = /'|\\/g, be = new RegExp("\\\\([\\da-f]{1,6}" + re + "?|(" + re + ")|.)","ig"), xe = function(e, t, n) {
            var r = "0x" + t - 65536;
            return r != r || n ? t : r < 0 ? String.fromCharCode(r + 65536) : String.fromCharCode(r >> 10 | 55296, 1023 & r | 56320)
        };
        try {
            K.apply(Z = ee.call(I.childNodes), I.childNodes),
        ...
        A = t.setDocument = function(e) {
            ...
            return n !== E && 9 === n.nodeType && n.documentElement ? (E = n,
            Y = n.documentElement,
            j = !S(n),
            ...
            x.find.CLASS = b.getElementsByClassName && function(e, t) {
                if (typeof t.getElementsByClassName !== G && j)
            ...
            t = ye.test(Y.compareDocumentPosition),
            H = t || ye.test(Y.contains) ? function(e, t) {
            ...
            z = t ? function(e, t) {
                ...
                return r || (1 & (r = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || !b.sortDetached && t.compareDocumentPosition(e) === r ? e === n || e.ownerDocument === I && H(I, e) ? -1 : t === n || t.ownerDocument === I && H(I, t) ? 1 : N ? te.call(N, e) - te.call(N, t) : 0 : 4 & r ? -1 : 1)
            }
            : function(e, t) {
                if (e === t)
                    return O = !0,
                ...
                if (!o || !a)
                    return e === n ? -1 : t === n ? 1 : o ? -1 : a ? 1 : N ? te.call(N, e) - te.call(N, t) : 0;
                if (o === a)
                    return s(e, t);
        ...
        t.matchesSelector = function(e, n) {
            if ((e.ownerDocument || e) !== E && A(e),
            n = n.replace(fe, "='$1']"),
            b.matchesSelector && j && (!R || !R.test(n)) && (!P || !P.test(n)))
                try {
                    var r = L.call(e, n);
        ...
        t.contains = function(e, t) {
            return (e.ownerDocument || e) !== E && A(e),
            H(e, t)
        }
        ,
        t.attr = function(e, t) {
        ...
        x = t.selectors = {
            ...
            preFilter: {
                ...
                PSEUDO: function(e) {
                    var t, n = !e[6] && e[2];
                    return pe.CHILD.test(e[0]) ? null : (e[3] ? e[2] = e[4] || e[5] || "" : n && he.test(n) && (t = T(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && (e[0] = e[0].slice(0, t),
                    e[2] = n.slice(0, t)),
                    e.slice(0, 3))
                }
            },
            filter: {
                ...
                CHILD: function(e, t, n, r, i) {
                    ...
                    : function(t, n, u) {
                        var l, c, f, h, d, p, m = o !== s ? "nextSibling" : "previousSibling", g = t.parentNode, y = a && t.nodeName.toLowerCase(), v = !u && !a;
                        if (g) {
                            if (o) {
                                for (; m; ) {
                                    for (f = t; f = f[m]; )
                            ...
                            } else if (v && (l = (t[F] || (t[F] = {}))[e]) && l[0] === W)
                                h = l[1];
                            else
                                for (; (f = ++d && f && f[m] || (h = d = 0) || p.pop()) && ((a ? f.nodeName.toLowerCase() !== y : 1 !== f.nodeType) || !++h || (v && ((f[F] || (f[F] = {}))[e] = [W, h]),
                                f !== t)); )
                                    ;
        ...
        T = t.tokenize = function(e, n) {
            ...
            u = [],
            l = x.preFilter; a; ) {
                for (s in r && !(i = le.exec(a)) || (i && (a = a.slice(i[0].length) || a),
                u.push(o = [])),
                r = !1,
        ...
        C = t.select = function(e, t, n, r) {
            var i, o, s, a, u, l = "function" == typeof e && e, f = !r && T(e = l.selector || e);
            if (n = n || [],
            1 === f.length) {
                if ((o = f[0] = f[0].slice(0)).length > 2 && "ID" === (s = o[0]).type && b.getById && 9 === t.nodeType && j && x.relative[o[1].type]) {
                    if (!(t = (x.find.ID(s.matches[0].replace(be, xe), t) || [])[0]))
                        return n;
                    l && (t = t.parentNode),
            ...
            return (l || D(e, f))(r, t, !j, n, _e.test(e) && c(t.parentNode) || t),
            n
        }
        ,
    ...
    (K.fn.init = function(e, t) {
        ...
        if ("string" == typeof e) {
            ...
            if (n[1]) {
                ...
                K.merge(this, K.parseHTML(n[1], t && t.nodeType ? t.ownerDocument || t : X, !0)),
                se.test(n[1]) && K.isPlainObject(t))
                    for (n in t)
                        K.isFunction(this[n]) ? this[n](t[n]) : this.attr(n, t[n]);
                return this
            }
            return (r = X.getElementById(n[2])) && r.parentNode && (this.length = 1,
            this[0] = r),
            this.context = X,
            this.selector = e,
            this
    ...
    K.extend({
        ...
        when: function(e) {
            var t, n, r, i = 0, o = U.call(arguments), s = o.length, a = 1 !== s || e && K.isFunction(e.promise) ? s : 0, u = 1 === a ? e : K.Deferred(), l = function(e, n, r) {
                return function(i) {
                    n[e] = this,
    ...
    K.extend({
        ...
        ready: function(e) {
            ...
            !0 !== e && --K.readyWait > 0 || (he.resolveWith(X, [K]),
            K.fn.triggerHandler && (K(X).triggerHandler("ready"),
            K(X).off("ready"))))
        }
    }),
    K.ready.promise = function(t) {
        return he || (he = K.Deferred(),
    ...
    a.prototype = {
        ...
        remove: function(e, t) {
            ...
            if (void 0 === t)
                ...
                r = t in s ? [t, i] : (r = i)in s ? [r] : r.match(de) || []),
                n = r.length;
                for (; n--; )
                    delete s[r[n]]
            }
        ...
        data: function(e, t) {
            ...
            if (void 0 === e) {
                ...
                1 === o.nodeType && !ge.get(o, "hasDataAttrs"))) {
                    for (n = s.length; n--; )
                        s[n] && 0 === (r = s[n].name).indexOf("data-") && (r = K.camelCase(r.slice(5)),
                        u(o, r, i[r]));
    ...
    K.fn.extend({
        ...
        promise: function(e, t) {
            ...
            e = void 0),
            e = e || "fx"; s--; )
                (n = ge.get(o[s], e + "queueHooks")) && n.empty && (r++,
                n.empty.add(a));
            return a(),
            i.promise(t)
        }
    });
    var we, be, xe = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, ke = ["Top", "Right", "Bottom", "Left"], Se = function(e, t) {
        return e = t || e,
    ...
    we.appendChild(be),
    Z.checkClone = we.cloneNode(!0).cloneNode(!0).lastChild.checked,
    we.innerHTML = "<textarea>x</textarea>",
    Z.noCloneChecked = !!we.cloneNode(!0).lastChild.defaultValue;
    var De = "undefined";
    ...
    K.event = {
        ...
        add: function(e, t, n, r, i) {
            ...
            if (g)
                ...
                l = (t = (t || "").match(de) || [""]).length; l--; )
                    ...
                    f.setup && !1 !== f.setup.call(e, r, p, s) || e.addEventListener && e.addEventListener(d, s, !1)),
            ...
            if (g && (u = g.events)) {
                for (l = (t = (t || "").match(de) || [""]).length; l--; )
                    ...
                    d) {
                        ...
                        s && !h.length && (f.teardown && !1 !== f.teardown.call(e, p, g.handle) || K.removeEvent(e, d, g.handle),
                        delete u[d])
                    } else
                        for (d in u)
        ...
        trigger: function(t, n, r, i) {
            var o, s, a, u, l, c, f, h = [r || X], d = Q.call(t, "type") ? t.type : t, p = Q.call(t, "namespace") ? t.namespace.split(".") : [];
            if (s = a = r = r || X,
            3 !== r.nodeType && 8 !== r.nodeType && !Ne.test(d + K.event.triggered) && (d.indexOf(".") >= 0 && (p = d.split("."),
            d = p.shift(),
            p.sort()),
            l = d.indexOf(":") < 0 && "on" + d,
            (t = t[K.expando] ? t : new K.Event(d,"object" == typeof t && t)).isTrigger = i ? 2 : 3,
            t.namespace = p.join("."),
            ...
            i || !f.trigger || !1 !== f.trigger.apply(r, n))) {
                ...
                for (o = 0; (s = h[o++]) && !t.isPropagationStopped(); )
                    ...
                    (c = (ge.get(s, "events") || {})[t.type] && ge.get(s, "handle")) && c.apply(s, n),
                    (c = l && s[l]) && c.apply && K.acceptData(s) && (t.result = c.apply(s, n),
                    !1 === t.result && t.preventDefault());
                return t.type = d,
                i || t.isDefaultPrevented() || f._default && !1 !== f._default.apply(h.pop(), n) || !K.acceptData(r) || l && K.isFunction(r[d]) && !K.isWindow(r) && ((a = r[l]) && (r[l] = null),
                K.event.triggered = d,
                r[d](),
        ...
        dispatch: function(e) {
            e = K.event.fix(e);
            var t, n, r, i, o, s = [], a = U.call(arguments), u = (ge.get(this, "events") || {})[e.type] || [], l = K.event.special[e.type] || {};
            if (a[0] = e,
            e.delegateTarget = this,
            !l.preDispatch || !1 !== l.preDispatch.call(this, e)) {
                for (s = K.event.handlers.call(this, e, u),
                t = 0; (i = s[t++]) && !e.isPropagationStopped(); )
                    ...
                    n = 0; (o = i.handlers[n++]) && !e.isImmediatePropagationStopped(); )
                        ...
                        e.data = o.data,
                        void 0 !== (r = ((K.event.special[o.origType] || {}).handle || o.handler).apply(i.elem, a)) && !1 === (e.result = r) && (e.preventDefault(),
                        e.stopPropagation()));
        ...
        mouseHooks: {
            ...
            filter: function(e, t) {
                ...
                return null == e.pageX && null != t.clientX && (r = (n = e.target.ownerDocument || X).documentElement,
                i = n.body,
        ...
        fix: function(e) {
            ...
            for (s || (this.fixHooks[i] = s = Me.test(i) ? this.mouseHooks : Ce.test(i) ? this.keyHooks : {}),
        ...
        clone: function(e, t, n) {
            ...
            if (t)
                if (n)
                    ...
                    g(e, a);
            return (s = y(a, "script")).length > 0 && m(s, !u && y(e, "script")),
            a
        },
    ...
    K.fn.extend({
        ...
        domManip: function(e, t) {
            e = $.apply([], e);
            var n, r, i, o, s, a, u = 0, l = this.length, c = this, f = l - 1, h = e[0], m = K.isFunction(h);
            if (m || l > 1 && "string" == typeof h && !Z.checkClone && Pe.test(h))
            ...
            r)) {
                for (o = (i = K.map(y(n, "script"), d)).length; u < l; u++)
                    s = n,
                    u !== f && (s = K.clone(s, !0, !0),
                    o && K.merge(i, y(s, "script"))),
                    t.call(this[u], s, u);
                if (o)
                    ...
                    u = 0; u < o; u++)
                        s = i[u],
                        Re.test(s.type || "") && !ge.access(s, "globalEval") && K.contains(a, s) && (s.src ? K._evalUrl && K._evalUrl(s.src) : K.globalEval(s.textContent.replace(He, "")))
            }
            return this
        }
    }),
    K.each({
        ...
        K.fn[e] = function(e) {
            for (var n, r = [], i = K(e), o = i.length - 1, s = 0; s <= o; s++)
    ...
    var Ie, We = {}, qe = /^margin/, Ue = new RegExp("^(" + xe + ")(?!px)[a-z%]+$","i"), $e = function(e) {
    ...
    K.extend({
        ...
        style: function(e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                ...
                if (t = K.cssProps[a] || (K.cssProps[a] = k(u, a)),
                s = K.cssHooks[t] || K.cssHooks[a],
                void 0 === n)
                    return s && "get"in s && void 0 !== (i = s.get(e, !1, r)) ? i : u[t];
                "string" === (o = typeof n) && (i = Ge.exec(n)) && (n = (i[1] + 1) * i[2] + parseFloat(K.css(e, t)),
                o = "number"),
        ...
        css: function(e, t, n, r) {
            ...
            return t = K.cssProps[a] || (K.cssProps[a] = k(e.style, a)),
    ...
    K.each(["height", "width"], (function(e, t) {
        K.cssHooks[t] = {
            get: function(e, n, r) {
                if (n)
                    return Ve.test(K.css(e, "display")) && 0 === e.offsetWidth ? K.swap(e, Be, (function() {
                        return D(e, t, r)
                    }
                    )) : D(e, t, r)
            },
    ...
    K.fx.step = {};
    var Xe, Je, Ke = /^(?:toggle|show|hide)$/, et = new RegExp("^(?:([+-])=|)(" + xe + ")([a-z%]*)$","i"), tt = /queueHooks$/, nt = [E], rt = {
        "*": [function(e, t) {
    ...
    K.fn.extend({
        ...
        finish: function(e) {
            return !1 !== e && (e = e || "fx"),
            this.each((function() {
                var t, n = ge.get(this), r = n[e + "queue"], i = n[e + "queueHooks"], o = K.timers, s = r ? r.length : 0;
                for (n.finish = !0,
                K.queue(this, e, []),
    ...
    K.fn.extend({
        ...
        toggleClass: function(e, t) {
            ...
            return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : K.isFunction(e) ? this.each((function(n) {
                ...
                if ("string" === n)
                    for (var t, r = 0, i = K(this), o = e.match(de) || []; t = o[r++]; )
            ...
            select: {
                ...
                set: function(e, t) {
                    for (var n, r, i = e.options, o = K.makeArray(t), s = i.length; s--; )
                        ((r = i[s]).selected = K.inArray(r.value, o) >= 0) && (n = !0);
    ...
    ;
    var ht, dt, pt = /#.*$/, mt = /([?&])_=[^&]*/, gt = /^(.*?):[ \t]*([^\r\n]*)$/gm, yt = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, vt = /^(?:GET|HEAD)$/, _t = /^\/\//, wt = /^([\w.+-]+:)(?:\/\/(?:[^\/?#]*@|)([^\/?#:]*)(?::(\d+)|)|)/, bt = {}, xt = {}, kt = "*/".concat("*");
    try {
        dt = location.href
    } catch (e) {
        (dt = X.createElement("a")).href = "",
        dt = dt.href
    }
    ht = wt.exec(dt.toLowerCase()) || [],
    K.extend({
        active: 0,
        lastModified: {},
        etag: {},
        ...
        ajax: function(e, t) {
            function n(e, t, n, s) {
                ...
                n && (v = H(f, b, n)),
                v = F(f, v, b, u),
                u ? (f.ifModified && ((w = b.getResponseHeader("Last-Modified")) && (K.lastModified[i] = w),
                (w = b.getResponseHeader("etag")) && (K.etag[i] = w)),
            ...
            e = void 0),
            t = t || {};
            var r, i, o, s, a, u, l, c, f = K.ajaxSetup({}, t), h = f.context || f, d = f.context && (h.nodeType || h.jquery) ? K(h) : K.event, p = K.Deferred(), m = K.Callbacks("once memory"), g = f.statusCode || {}, y = {}, v = {}, _ = 0, w = "canceled", b = {
                readyState: 0,
            ...
            b.success = b.done,
            b.error = b.fail,
            f.url = ((e || f.url || dt) + "").replace(pt, "").replace(_t, ht[1] + "//"),
            f.type = t.method || t.type || f.method || f.type,
            f.dataTypes = K.trim(f.dataType || "*").toLowerCase().match(de) || [""],
            null == f.crossDomain && (u = wt.exec(f.url.toLowerCase()),
            f.crossDomain = !(!u || u[1] === ht[1] && u[2] === ht[2] && (u[3] || ("http:" === u[1] ? "80" : "443")) === (ht[3] || ("http:" === ht[1] ? "80" : "443")))),
            ...
            if (f.beforeSend && (!1 === f.beforeSend.call(h, b, f) || 2 === _))
                return b.abort();
            for (c in w = "abort",
            {
                success: 1,
    ...
    K.fn.extend({
        ...
        serializeArray: function() {
            return this.map((function() {
                ...
                var e = this.type;
                return this.name && !K(this).is(":disabled") && Mt.test(this.nodeName) && !Ct.test(e) && (this.checked || !Te.test(e))
            }
            )).map((function(e, t) {
                var n = K(this).val();
    ...
    K.ajaxPrefilter("json jsonp", (function(t, n, r) {
        ...
        if (a || "jsonp" === t.dataTypes[0])
            ...
            a ? t[a] = t[a].replace(jt, "$1" + i) : !1 !== t.jsonp && (t.url += (ft.test(t.url) ? "&" : "?") + t.jsonp + "=" + i),
    ...
    K.fn.extend({
        ...
        offsetParent: function() {
            return this.map((function() {
                for (var e = this.offsetParent || Rt; e && !K.nodeName(e, "html") && "static" === K.css(e, "position"); )
                    e = e.offsetParent;
                return e || Rt
            }
            ))
...
function(e, t) {
    ...
    for (d in p)
        r[d + "PathSegment"] = m("pathname", p[d]);
    for (d in r.encodeReserved = m("reserved", "encode"),
    ...
    r.parseQuery = function(e) {
        ...
        if (!(e = e.replace(/&+/g, "&").replace(/^\?*&*|&+$/g, "")))
            return {};
        for (var t, n, i, o = {}, s = e.split("&"), a = s.length, u = 0; u < a; u++)
            t = s[u].split("="),
        ...
        for (i in e)
            if (h.call(e, i) && i)
                if (s(e[i]))
                    ...
                    o = 0,
                    a = e[i].length; o < a; o++)
                        void 0 !== e[i][o] && void 0 === n[e[i][o] + ""] && (u += "&" + r.buildQueryParameter(i, e[i][o]),
                        !0 !== t && (n[e[i][o] + ""] = !0));
                else
                    void 0 !== e[i] && (u += "&" + r.buildQueryParameter(i, e[i]));
    ...
    r.removeQuery = function(e, t, n) {
        ...
        if (s(t))
            ...
            for (u in t)
                h.call(t, u) && r.removeQuery(e, u, t[u]);
        else {
            if ("string" != typeof t)
    ...
    r.hasQuery = function(e, t, n, i) {
        if ("object" == typeof t) {
            for (var a in t)
                if (h.call(t, a) && !r.hasQuery(e, a, t[a]))
                    return !1;
            return !0
        }
        if ("string" != typeof t)
    ...
    ,
    f.build = function(e) {
        return !0 === e ? this._deferred_build = !0 : (void 0 === e || this._deferred_build) && (this._string = r.build(this._parts),
    ...
    f.href = function(e, t) {
        ...
        if (!i && o && void 0 !== e.pathname && (e = e.toString()),
        "string" == typeof e)
            ...
            var s = i ? e._parts : e;
            for (n in s)
                h.call(this._parts, n) && (this._parts[n] = s[n])
        }
        return this.build(!t),
        this
    }
    ...
    f.is = function(e) {
        ...
        a = (s = !(t = i || o)) && n && n.has(this._parts.hostname),
        u = s && r.idn_expression.test(this._parts.hostname),
        l = s && r.punycode_expression.test(this._parts.hostname)),
        e.toLowerCase()) {
        case "relative":
            return c;
        case "absolute":
    ...
    f.protocol = function(e, t) {
        if (void 0 !== e && e && (e = e.replace(/:(\/\/)?$/, "")).match(/[^a-zA-z0-9\.+-]/))
    ...
    f.suffix = function(e, t) {
        ...
        if (void 0 === e || !0 === e) {
            if (!this._parts.path || "/" === this._parts.path)
                return "";
            var n, o, s = this.filename(), a = s.lastIndexOf(".");
        ...
        var u, l = this.suffix();
        if (l)
            u = e ? new RegExp(i(l) + "$") : new RegExp(i("." + l) + "$");
        else {
            if (!e)
                return this;
    ...
    f.segment = function(e, t, n) {
        ...
        void 0 === t ? void 0 === e ? a : a[e] : (null === e || void 0 === a[e] ? s(t) ? a = t : (t || "string" == typeof t && t.length) && ("" === a[a.length - 1] ? a[a.length - 1] = t : a.push(t)) : t || "string" == typeof t && t.length ? a[e] = t : a.splice(e, 1),
        o && a.unshift(""),
    ...
    f.readable = function() {
        ...
        t._parts.query) {
            for (var i = "", o = 0, s = t._parts.query.split("&"), a = s.length; o < a; o++) {
                ...
                void 0 !== u[1] && (i += "=" + r.decodeQuery(u[1]).replace(/&/g, "%26"))
            }
            n += "?" + i.substring(1)
        }
        return n += t.hash()
    ...
    f.absoluteTo = function(e) {
        var t, n, i, o = this.clone(), s = ["protocol", "username", "password", "hostname", "port"];
        if (this._parts.urn)
    ...
    f.relativeTo = function(e) {
        var t, n, o, s, a = this.clone(), u = ["protocol", "username", "password", "hostname", "port"];
        if (a._parts.urn)
            throw new Error("URNs do not have any generally defined hierachical components");
        if (e instanceof r || (e = new r(e)),
        "/" !== a.path().charAt(0) || "/" !== e.path().charAt(0))
            throw new Error("Cannot calculate common path from non-relative URLs");
        t = r.commonPath(a.path(), e.path());
        for (var l, c = 0; l = u[c]; c++)
            a._parts[l] = null;
        if ("/" === t)
            return a;
        if (!t)
            return this.clone();
        if ((n = e.directory()) === (o = a.directory()))
            return a._parts.path = a.filename(),
            a.build();
        if (n.substring(t.length),
        s = o.substring(t.length),
        n + "/" === t)
            return s && (s += "/"),
            a._parts.path = s + a.filename(),
            a.build();
        for (var f = "../", h = new RegExp("^" + i(t)), d = n.replace(h, "/").match(/\//g).length - 1; d--; )
            f += "../";
        return a._parts.path = a._parts.path.replace(h, f),
        a.build()
    }
    ,
    f.equals = function(e) {
        var t, n, i, o = this.clone(), a = new r(e), u = {}, c = {}, f = {};
        if (o.normalize(),
        a.normalize(),
...
function(e, t) {
    ...
    function a(e) {
        return null != e && Ot(e.getInt8) && Ct(e.buffer)
    }
    function u(e, t) {
    ...
    function g(e, t) {
        ...
        for (u(e, o) && !t.contains(o) && t.push(o); n--; )
            (o = _t[n])in e && e[o] !== i[o] && !t.contains(o) && t.push(o)
    }
    function y(e) {
        if (!t(e))
            return [];
    ...
    function v(e) {
        if (null == e)
            return !0;
        var t = Ut(e);
        return "number" == typeof t && (Rt(e) || bt(e) || Ht(e)) ? 0 === t : 0 === Ut(y(e))
    }
    function _(e, t) {
        var n = y(t)
          , r = n.length;
    ...
    function k(e, t, n, r) {
        ...
        if (!o) {
            ...
            var s = e.constructor
              , a = t.constructor;
            if (s !== a && !(Ot(s) && s instanceof s && Ot(a) && a instanceof a) && "constructor"in e && "constructor"in t)
                return !1
        }
        r = r || [];
    ...
    function W(e, t) {
        for (var n = (t = H(t)).length, r = 0; r < n; r++) {
            var i = t[r];
            if (!u(e, i))
                return !1;
            e = e[i]
    ...
    function _e(e, t, n) {
        return function(r, i, o) {
            ...
            if (i != i)
                return (o = t(at.call(r, s, a), c)) >= 0 ? o + s : -1;
    ...
    function Ee(e, t, n) {
        ...
        if (null == t || "number" == typeof t && "object" != typeof e[0] && null != e)
            for (var a = 0, u = (e = vn(e) ? e : C(e)).length; a < u; a++)
                null != (r = e[a]) && r > o && (o = r);
        else
            t = B(t, n),
            xe(e, (function(e, n, r) {
                ((i = t(e, n, r)) > s || i === -1 / 0 && o === -1 / 0) && (o = e,
                s = i)
            }
            ));
        return o
    ...
    function je(e) {
        return e ? Rt(e) ? at.call(e) : bt(e) ? e.match(On) : vn(e) ? ke(e, q) : C(e) : []
    }
    function Pe(e, t, n) {
        if (null == t || n)
            return vn(e) || (e = C(e)),
    ...
    function Qe(e) {
        for (var t = e && Ee(e, Ut).length || 0, n = Array(t), r = 0; r < t; r++)
            n[r] = Oe(e, r);
        return n
    }
    function Ze(e, t) {
    ...
    "function" != typeof /./ && "object" != typeof Int8Array && "function" != typeof Nt && (Mt = function(e) {
    ...
    var sn = Date.now || function() {
      ...
      , gn = e((function(e, t) {
        var n = gn.placeholder
          , r = function() {
            for (var i = 0, o = t.length, s = Array(o), a = 0; a < o; a++)
    ...
    var yn = e((function(t, n, r) {
      ...
      , On = /[^\ud800-\udfff]|[\ud800-\udbff][\udc00-\udfff]|[\ud800-\udfff]/g
      , An = He((function(e, t, n) {
        u(e, n) ? e[n].push(t) : e[n] = [t]
    }
    ))
      , En = He((function(e, t, n) {
        e[n] = t
    }
    ))
      , Yn = He((function(e, t, n) {
        u(e, n) ? e[n]++ : e[n] = 1
    }
    ))
      , jn = He((function(e, t, n) {
        e[n ? 0 : 1].push(t)
    }
    ), !0)
      , Pn = e((function(e, t) {
      ...
      , Rn = e((function(e, t) {
        var n, r = t[0];
        return Ot(r) ? (r = he(r),
        t.length > 1 && (n = t[1])) : (t = ke(ae(t, !1, !1), String),
        r = function(e, n) {
            return !Ne(t, n)
        }
        ),
...
function(e, t) {
    ...
    function m(e) {
        var t = f(NaN);
        return null != e ? c(d(t), e) : d(t).userInvalidated = !0,
        t
    }
    function g(e, t) {
    ...
    function w(t, n) {
        ...
        return c((function() {
            ...
            r) {
                var o, s, a, u = [], l = arguments.length;
                for (s = 0; s < l; s++) {
                    if (o = "",
                    "object" == typeof arguments[s]) {
                        for (a in o += "\n[" + s + "] ",
                        arguments[0])
                            i(arguments[0], a) && (o += a + ": " + arguments[0][a] + ", ");
                        o = o.slice(0, -2)
                    } else
                        o = arguments[s];
                    u.push(o)
    ...
    function A(e, t) {
        return e.isValid() ? (t = E(t, e.localeData()),
        fi[t] = fi[t] || O(t),
    ...
    function B(e, t, n) {
        e.isValid() && !isNaN(n) && ("FullYear" === t && U(e.year()) && 1 === e.month() && 29 === e.date() ? (n = V(n),
    ...
    function de(e) {
        ...
        e ? this._monthsShortStrictRegex : this._monthsShortRegex) : (i(this, "_monthsShortRegex") || (this._monthsShortRegex = Xi),
        this._monthsShortStrictRegex && e ? this._monthsShortStrictRegex : this._monthsShortRegex)
    }
    function pe(e) {
        return this._monthsParseExact ? (i(this, "_monthsRegex") || me.call(this),
        e ? this._monthsStrictRegex : this._monthsRegex) : (i(this, "_monthsRegex") || (this._monthsRegex = Ji),
    ...
    function ve(e, t, n, r, i, o, s) {
        var a;
        return e < 100 && e >= 0 ? (a = new Date(e + 400,t,n,r,i,o,s),
    ...
    function be(e, t, n, r, i) {
        ...
        return a <= 0 ? s = ge(o = e - 1) + a : a > ge(e) ? (o = e + 1,
        s = a - ge(e)) : (o = e,
        s = a),
        {
            year: o,
    ...
    function xe(e, t, n) {
        ...
        return s < 1 ? r = s + ke(i = e.year() - 1, t, n) : s > ke(e.year(), t, n) ? (r = s - ke(e.year(), t, n),
        i = e.year() + 1) : (i = e.year(),
        r = s),
        {
            week: r,
    ...
    function Ie(e) {
        return this._weekdaysParseExact ? (i(this, "_weekdaysRegex") || Ue.call(this),
    ...
    function qe(e) {
        return this._weekdaysParseExact ? (i(this, "_weekdaysRegex") || Ue.call(this),
        e ? this._weekdaysMinStrictRegex : this._weekdaysMinRegex) : (i(this, "_weekdaysMinRegex") || (this._weekdaysMinRegex = so),
    ...
    function Je(e) {
        for (var t, n, r, i, o = 0; o < e.length; ) {
            for (t = (i = Xe(e[o]).split("-")).length,
            n = (n = Xe(e[o + 1])) ? n.split("-") : null; t > 0; ) {
                if (r = et(i.slice(0, t).join("-")))
                    return r;
                if (n && n.length >= t && Ze(i, n) >= t - 1)
                    break;
                t--
            }
            o++
    ...
    function tt(e, t) {
        var n;
        return e && ((n = s(t) ? it(e) : nt(e, t)) ? ao = n : "undefined" != typeof console && console.warn && console.warn("Locale " + e + " not found. Did you forget to load it?")),
        ao._abbr
    }
    function nt(e, t) {
        if (null !== t) {
    ...
    function st(e) {
        var t, n = e._a;
        return n && -2 === d(e).overflow && (t = n[Ii] < 0 || n[Ii] > 11 ? Ii : n[Wi] < 1 || n[Wi] > oe(n[Fi], n[Ii]) ? Wi : n[qi] < 0 || n[qi] > 24 || 24 === n[qi] && (0 !== n[Ui] || 0 !== n[$i] || 0 !== n[Vi]) ? qi : n[Ui] < 0 || n[Ui] > 59 ? Ui : n[$i] < 0 || n[$i] > 59 ? $i : n[Vi] < 0 || n[Vi] > 999 ? Vi : -1,
        d(e)._overflowDayOfYear && (t < Fi || t > Wi) && (t = Wi),
        d(e)._overflowWeeks && -1 === t && (t = zi),
        d(e)._overflowWeekday && -1 === t && (t = Gi),
        d(e).overflow = t),
        e
    }
    function at(e) {
        var t, n, r, i, o, s, a = e._i, u = po.exec(a) || mo.exec(a), l = yo.length, c = vo.length;
        if (u) {
            for (d(e).iso = !0,
            t = 0,
            n = l; t < n; t++)
    ...
    function yt(e) {
        ...
        if (!e._d) {
            for (r = gt(e),
            e._w && null == e._a[Wi] && null == e._a[Ii] && vt(e),
            null != e._dayOfYear && (o = mt(e._a[Fi], r[Fi]),
            (e._dayOfYear > ge(o) || 0 === e._dayOfYear) && (d(e)._overflowDayOfYear = !0),
            n = _e(o, 0, e._dayOfYear),
            e._a[Ii] = n.getUTCMonth(),
            e._a[Wi] = n.getUTCDate()),
            t = 0; t < 3 && null == e._a[t]; ++t)
                e._a[t] = s[t] = r[t];
            for (; t < 7; t++)
                e._a[t] = s[t] = null == e._a[t] ? 2 === t ? 1 : 0 : e._a[t];
            24 === e._a[qi] && 0 === e._a[Ui] && 0 === e._a[$i] && 0 === e._a[Vi] && (e._nextDay = !0,
            e._a[qi] = 0),
            e._d = (e._useUTC ? _e : ve).apply(null, s),
            i = e._useUTC ? e._d.getUTCDay() : e._d.getDay(),
            null != e._tzm && e._d.setUTCMinutes(e._d.getUTCMinutes() - e._tzm),
            e._nextDay && (e._a[qi] = 24),
            e._w && void 0 !== e._w.d && e._w.d !== i && (d(e).weekdayMismatch = !0)
        }
    }
    function vt(e) {
        var t, n, r, i, o, s, a, u, l;
        ...
        s = 4,
        n = mt(t.GG, e._a[Fi], xe(Ct(), 1, 4).year),
        r = mt(t.W, 1),
        ...
        (t.e < 0 || t.e > 6) && (u = !0)) : i = o),
        r < 1 || r > ke(n, o, s) ? d(e)._overflowWeeks = !0 : null != u ? d(e)._overflowWeekday = !0 : (a = be(n, r, i, o, s),
        e._a[Fi] = a.year,
    ...
    function _t(t) {
        if (t._f !== e.ISO_8601)
            if (t._f !== e.RFC_2822) {
                t._a = [],
                d(t).empty = !0;
                var n, r, i, o, s, a, u, l = "" + t._i, c = l.length, f = 0;
                for (u = (i = E(t._f, t._locale).match(li) || []).length,
                n = 0; n < u; n++)
                    o = i[n],
                    (r = (l.match(J(o, t)) || [])[0]) && ((s = l.substr(0, l.indexOf(r))).length > 0 && d(t).unusedInput.push(s),
                    l = l.slice(l.indexOf(r) + r.length),
                    f += r.length),
                    hi[o] ? (r ? d(t).empty = !1 : d(t).unusedTokens.push(o),
                    re(o, r, t)) : t._strict && !r && d(t).unusedTokens.push(o);
                d(t).charsLeftOver = c - f,
                l.length > 0 && d(t).unusedInput.push(l),
                t._a[qi] <= 12 && !0 === d(t).bigHour && t._a[qi] > 0 && (d(t).bigHour = void 0),
                d(t).parsedDateParts = t._a.slice(0),
                d(t).meridiem = t._meridiem,
                t._a[qi] = wt(t._locale, t._a[qi], t._meridiem),
                null !== (a = d(t).era) && (t._a[Fi] = t._locale.erasConvertYear(a, t._a[Fi])),
                yt(t),
                st(t)
            } else
                dt(t);
    ...
    function St(e) {
        ...
        v(t) ? new y(st(t)) : (u(t) ? e._d = t : n(r) ? bt(e) : r ? _t(e) : Tt(e),
        p(e) || (e._d = null),
        e))
    }
    function Tt(t) {
    ...
    function At(e) {
        ...
        for (t in e)
            if (i(e, t) && (-1 === Li.call(To, t) || null != e[t] && isNaN(e[t])))
                return !1;
        for (n = 0; n < o; ++n)
            if (e[To[n]]) {
                if (r)
    ...
    function It(t, n) {
        ...
        i = (v(t) || u(t) ? t.valueOf() : Ct(t).valueOf()) - r.valueOf(),
    ...
    function qt(t, n, r) {
        ...
        if (null != t) {
            ...
            return !this._isUTC && n && (i = Wt(this)),
            this._offset = t,
            this._isUTC = !0,
            null != i && this.add(i, "m"),
    ...
    function Qt() {
        ...
        var e, t = {};
        return g(t, this),
        (t = St(t))._a ? (e = t._isUTC ? f(t._a) : Ct(t._a),
        this._isDSTShifted = this.isValid() && Lt(t._a, e.toArray()) > 0) : this._isDSTShifted = !1,
        this._isDSTShifted
    }
    function Zt() {
    ...
    function Kt(e, t) {
        var n, r, o, s = e, u = null;
        return Pt(e) ? s = {
            ms: e._milliseconds,
            d: e._days,
            M: e._months
        } : a(e) || !isNaN(+e) ? (s = {},
        t ? s[t] = +e : s.milliseconds = +e) : (u = Co.exec(e)) ? (n = "-" === u[1] ? -1 : 1,
        s = {
            y: 0,
            d: V(u[Wi]) * n,
            h: V(u[qi]) * n,
        ...
        s = {
            ...
            m: en(u[7], n),
            s: en(u[8], n)
        }) : null == s ? s = {} : "object" == typeof s && ("from"in s || "to"in s) && (o = nn(Ct(s.from), Ct(s.to)),
        (s = {}).ms = o.milliseconds,
        s.M = o.months),
        r = new jt(s),
        Pt(e) && i(e, "_locale") && (r._locale = e._locale),
        Pt(e) && i(e, "_isValid") && (r._isValid = e._isValid),
        r
    }
    function en(e, t) {
    ...
    function on(t, n, r, i) {
        ...
        a && ce(t, G(t, "Month") + a * r),
        s && B(t, "Date", G(t, "Date") + s * r),
    ...
    function un(e) {
        var t, n, s = r(e) && !o(e), a = !1, u = ["years", "year", "y", "months", "month", "M", "days", "day", "d", "dates", "date", "D", "hours", "hour", "h", "minutes", "minute", "m", "seconds", "second", "s", "milliseconds", "millisecond", "ms"], l = u.length;
        for (t = 0; t < l; t += 1)
            n = u[t],
            a = a || i(e, n);
        return s && a
    ...
    function cn(e) {
        var t, n, s = r(e) && !o(e), a = !1, u = ["sameDay", "nextDay", "lastDay", "nextWeek", "lastWeek", "sameElse"];
    ...
    function hn(t, n) {
        1 === arguments.length && (arguments[0] ? an(arguments[0]) ? (t = arguments[0],
        ...
        return this.format(s || this.localeData().calendar(o, this, Ct(r)))
    }
    function dn() {
        return new y(this)
    }
    ...
    function Dn(e, t) {
        return this.isValid() && (v(e) && e.isValid() || Ct(e).isValid()) ? Kt({
            to: this,
            from: e
    ...
    function Pn(t) {
        ...
        case "hour":
            n = this._d.valueOf(),
            n -= En(n + (this._isUTC ? 0 : this.utcOffset() * Yo), jo);
            break;
        case "minute":
            n = this._d.valueOf(),
            n -= En(n, Yo);
    ...
    function Rn(t) {
        ...
        case "hour":
            n = this._d.valueOf(),
            n += jo - En(n + (this._isUTC ? 0 : this.utcOffset() * Yo), jo) - 1;
            break;
        case "minute":
            n = this._d.valueOf(),
            n += Yo - En(n, Yo) - 1;
    ...
    function er(e) {
        return i(this, "_erasNameRegex") || ar.call(this),
        e ? this._erasNameRegex : this._erasRegex
    }
    function tr(e) {
        return i(this, "_erasAbbrRegex") || ar.call(this),
        e ? this._erasAbbrRegex : this._erasRegex
    }
    function nr(e) {
        return i(this, "_erasNarrowRegex") || ar.call(this),
    ...
    function Cr(e, t, n, r) {
        ...
        t = void 0),
        t = t || "");
        var i, o = it(), s = e ? o._week.dow : 0, u = [];
        if (null != n)
            return Tr(t, (n + s) % 7, r, "day");
        for (i = 0; i < 7; i++)
            u[i] = Tr(t, (i + s) % 7, r, "day");
        return u
    }
    function Mr(e, t) {
    ...
    function Or(e, t, n) {
        return Cr(e, t, n, "weekdays")
    }
    function Ar(e, t, n) {
        return Cr(e, t, n, "weekdaysShort")
    }
    function Er(e, t, n) {
        return Cr(e, t, n, "weekdaysMin")
    }
    function Yr() {
        var e = this._data;
    ...
    function Hr() {
        ...
        return o >= 0 && s >= 0 && a >= 0 || o <= 0 && s <= 0 && a <= 0 || (o += 864e5 * Lr(Ir(a) + s),
        s = 0,
        a = 0),
    ...
    function Qr(e, t, n, r) {
        ...
        (h = h || l <= 1 && ["M"] || l < n.M && ["MM", l] || f <= 1 && ["y"] || ["yy", f])[2] = t,
        h[3] = +e > 0,
        h[4] = r,
        Br.apply(null, h)
    }
    ...
    function Xr(e, t) {
        return void 0 !== as[e] && (void 0 === t ? as[e] : (as[e] = t,
        "s" === e && (as.ss = t - 1),
        !0))
    }
    function Jr(e, t) {
        ...
        "object" == typeof t && (o = Object.assign({}, as, t),
        null != t.s && null == t.ss && (o.ss = t.s - 1)),
        r = Qr(this, !i, o, n = this.localeData()),
    ...
    function ei() {
        if (!this.isValid())
            return this.localeData().invalidDate();
        var e, t, n, r, i, o, s, a, u = us(this._milliseconds) / 1e3, l = us(this._days), c = us(this._months), f = this.asSeconds();
        return f ? (e = $(u / 60),
        t = $(e / 60),
        u %= 60,
        e %= 60,
        ...
        s = Kr(this._days) !== Kr(f) ? "-" : "",
        a = Kr(this._milliseconds) !== Kr(f) ? "-" : "",
    ...
    ;
    var ri, ii = e.momentProperties = [], oi = !1, si = {};
    ...
    var ai, ui = {
        ...
        sameElse: "L"
    }, li = /(\[[^\[]*\])|(\\)?([Hh]mm(ss)?|Mo|MM?M?M?|Do|DDDo|DD?D?D?|ddd?d?|do?|w[o|w]?|W[o|W]?|Qo?|N{1,5}|YYYYYY|YYYYY|YYYY|YY|y{2,4}|yo?|gg(ggg?)?|GG(GGG?)?|e|E|a|A|hh?|HH?|kk?|mm?|ss?|S{1,9}|x|X|zz?|ZZ?|.)/g, ci = /(\[[^\[]*\])|(\\)?(LTS|LT|LL?L?L?|l{1,4})/g, fi = {}, hi = {}, di = {
        LTS: "h:mm:ss A",
        LT: "h:mm A",
        L: "MM/DD/YYYY",
        LL: "MMMM D, YYYY",
        ...
        y: "a year",
        yy: "%d years"
    }, vi = {}, _i = {}, wi = /\d/, bi = /\d\d/, xi = /\d{3}/, ki = /\d{4}/, Si = /[+-]?\d{6}/, Ti = /\d\d?/, Di = /\d\d\d\d?/, Ci = /\d\d\d\d\d\d?/, Mi = /\d{1,3}/, Ni = /\d{1,4}/, Oi = /[+-]?\d{1,6}/, Ai = /\d+/, Ei = /[+-]?\d+/, Yi = /Z|[+-]\d\d:?\d\d/gi, ji = /Z|[+-]\d\d(?::?\d\d)?/gi, Pi = /[+-]?\d+(\.\d{1,3})?/, Ri = /[0-9]{0,256}['a-z\u00A0-\u05FF\u0700-\uD7FF\uF900-\uFDCF\uFDF0-\uFF07\uFF10-\uFFEF]{1,256}|[\u0600-\u06FF\/]{1,256}(\s*?[\u0600-\u06FF]{1,256}){1,2}/i;
    ai = {};
    var Li, Hi = {}, Fi = 0, Ii = 1, Wi = 2, qi = 3, Ui = 4, $i = 5, Vi = 6, zi = 7, Gi = 8;
    ...
    M("k", ["kk", 2], 0, Ve),
    M("hmm", 0, 0, (function() {
        return "" + $e.apply(this) + C(this.minutes(), 2)
    }
    )),
    M("hmmss", 0, 0, (function() {
        return "" + $e.apply(this) + C(this.minutes(), 2) + C(this.seconds(), 2)
    }
    )),
    M("Hmm", 0, 0, (function() {
    ...
    var ao, uo = /[ap]\.?m?\.?/i, lo = z("Hours", !0), co = {
        calendar: ui,
        longDateFormat: di,
        invalidDate: pi,
        ordinal: mi,
    ...
    X("SS", Mi, bi),
    X("SSS", Mi, xi),
    Ho = "SSSS"; Ho.length <= 9; Ho += "S")
        X(Ho, Ai);
    for (Ho = "S"; Ho.length <= 9; Ho += "S")
        te(Ho, _r);
    Fo = z("Milliseconds", !1),
    M("z", 0, 0, "zoneAbbr"),
    M("zz", 0, 0, "zoneName");
    ...
    Wo.toISOString = kn,
    Wo.inspect = Sn,
    "undefined" != typeof Symbol && null != Symbol.for && (Wo[Symbol.for("nodejs.util.inspect.custom")] = function() {
    ...
    Wo.weekYear = lr,
    Wo.isoWeekYear = cr,
    Wo.quarter = Wo.quarters = yr,
    Wo.month = fe,
    Wo.daysInMonth = he,
    Wo.week = Wo.weeks = Ce,
    Wo.isoWeek = Wo.isoWeeks = Me,
    Wo.weeksInYear = dr,
    Wo.weeksInWeekYear = pr,
    Wo.isoWeeksInYear = fr,
    Wo.isoWeeksInISOWeekYear = hr,
    Wo.date = Ro,
    Wo.day = Wo.days = Le,
    Wo.weekday = He,
    Wo.isoWeekday = Fe,
    Wo.dayOfYear = vr,
    Wo.hour = Wo.hours = lo,
    Wo.minute = Wo.minutes = Lo,
    Wo.second = Wo.seconds = Io,
    Wo.millisecond = Wo.milliseconds = Fo,
    Wo.utcOffset = qt,
    Wo.utc = $t,
    Wo.local = Vt,
    Wo.parseZone = zt,
    Wo.hasAlignedHourOffset = Gt,
    Wo.isDST = Bt,
    Wo.isLocal = Zt,
    Wo.isUtcOffset = Xt,
    Wo.isUtc = Jt,
    ...
    Wo.zoneAbbr = wr,
    Wo.zoneName = br,
    Wo.dates = w("dates accessor is deprecated. Use date instead.", Ro),
    Wo.months = w("months accessor is deprecated. Use month instead", fe),
    Wo.years = w("years accessor is deprecated. Use year instead", Ki),
    Wo.zone = w("moment().zone is deprecated, use moment().utcOffset instead. http://momentjs.com/guides/#/warnings/zone/", Ut),
    Wo.isDSTShifted = w("isDSTShifted is deprecated. See http://momentjs.com/guides/#/warnings/dst-shifted/ for more information", Qt);
    var qo = T.prototype;
    qo.calendar = D,
    qo.longDateFormat = Y,
    qo.invalidDate = j,
    ...
    qo.eras = Gn,
    qo.erasParse = Bn,
    qo.erasConvertYear = Qn,
    qo.erasAbbrRegex = tr,
    qo.erasNameRegex = er,
    qo.erasNarrowRegex = nr,
    qo.months = se,
    qo.monthsShort = ae,
    qo.monthsParse = le,
    qo.monthsRegex = pe,
    qo.monthsShortRegex = de,
    qo.week = Se,
    qo.firstDayOfYear = De,
    qo.firstDayOfWeek = Te,
    qo.weekdays = Ee,
    qo.weekdaysMin = je,
    qo.weekdaysShort = Ye,
    qo.weekdaysParse = Re,
    qo.weekdaysRegex = Ie,
    qo.weekdaysShortRegex = We,
    qo.weekdaysMinRegex = qe,
    qo.isPM = Be,
    qo.meridiem = Qe,
    tt("en", {
        eras: [{
    ...
    e.lang = w("moment.lang is deprecated. Use moment.locale instead.", tt),
    e.langData = w("moment.langData is deprecated. Use moment.localeData instead.", it);
    var Uo = Math.abs
      , $o = Ur("ms")
      , Vo = Ur("s")
      , zo = Ur("m")
    ...
    ls.locale = On,
    ls.localeData = An,
    ls.toIsoString = w("toIsoString() is deprecated. Please use toISOString() instead (notice the capitals)", ei),
    ls.lang = Ao,
    M("X", 0, 0, "unix"),
    M("x", 0, 0, "valueOf"),
    X("x", Ei),
    ...
    e.weekdaysShort = Ar,
    e.normalizeUnits = F,
    e.relativeTimeRounding = Zr,
    e.relativeTimeThreshold = Xr,
    e.calendarFormat = fn,
    e.prototype = Wo,
    e.HTML5_FMT = {
...
Market.Helpers.GoogleAnalytics = {
    ...
    sendEvent(e, t, n, r) {
        r || (r = {});
        const {label: i, value: o, hitCallback: s, nonInteraction: a, dimension11: u} = r;
        if (window.ga && window._envGaTrackerNames) {
            const r = _.omit({
                hitType: e,
                eventCategory: t,
