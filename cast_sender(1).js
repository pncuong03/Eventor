...
*/
    ...
    var Ya = function(a) {
        ...
        return a.replace(Xa, function(d, e) {
            ...
            if (!g) {
                ...
                g = (e = x) ? e.createHTML(g) : g;
                g = new D(g,Sa);
                if (c.tagName && Va[c.tagName.toUpperCase()])
    ...
    chrome.cast.mb = function(a, b, c, d) {
        this.label = a;
        a = b;
        Da.test(a) && (-1 != a.indexOf("&") && (a = a.replace(xa, "&amp;")),
    ...
    f.Zb = function(a, b, c, d) {
        ...
        if (!(0 > e))
            if (0 > b)
                d && d(new chrome.cast.Error(chrome.cast.C.INVALID_PARAMETER));
            else if (e == b)
                c && c();
            else {
                var g = null;
    ...
    f.Ob = function() {
        if (this.breakStatus && void 0 !== this.breakStatus.currentBreakTime)
            return this.playerState == chrome.cast.media.F.PLAYING && 0 <= this.g ? this.breakStatus.currentBreakTime + (Date.now() - this.g) / 1E3 : this.breakStatus.currentBreakTime
    }
    ;
    f.Nb = function() {
        if (this.breakStatus && void 0 !== this.breakStatus.currentBreakClipTime)
            return this.playerState == chrome.cast.media.F.PLAYING && 0 <= this.g ? this.breakStatus.currentBreakClipTime + (Date.now() - this.g) / 1E3 : this.breakStatus.currentBreakClipTime
    }
    ;
    f.Pb = function() {
    ...
    var ib = function(a) {
        if (a instanceof H || a instanceof I || a instanceof J)
            return a;
    ...
    K.prototype.delete = function(a) {
        return M(this.h, a) ? (delete this.h[a],
        --this.size,
        this.j++,
        this.g.length > 2 * this.size && L(this),
        !0) : !1
    }
    ;
    var L = function(a) {
    ...
    var rb = function(a, b, c, d, e, g, k, l, q, w, yb, zb) {
      ...
      , sb = function(a) {
        var b = a.J.map(function(c) {
            ...
            a.u && (e.set("broadcastNamespace", a.u),
    ...
    var tb = function() {
      ...
      , wb = function(a, b) {
        ...
        if (c)
            return c.statusText = b.statusText,
        ...
        for (var d in b)
            "media" == d ? c.media = b.media.map(function(e) {
                e = vb(a, e);
                e.m = !1;
                e.j = !0;
                return e
      ...
      , vb = function(a, b) {
        var c = b.sessionId + "#" + b.mediaSessionId
          , d = a.h[c];
        d || (d = new chrome.cast.media.i(b.sessionId,b.mediaSessionId),
        a.h[c] = d,
        ...
        for (var e in b)
            "items" != e && b.hasOwnProperty(e) && ("volume" == e ? (a.volume.level = b.volume.level,
            a.volume.muted = b.volume.muted) : a[e] = b[e]);
        e = fa(["idleReason", "extendedStatus", "breakStatus"]);
        for (c = e.next(); !c.done; c = e.next())
            c = c.value,
            b.hasOwnProperty(c) || (a[c] = null);
        ...
        if (a.playerState == chrome.cast.media.F.IDLE && null == a.loadingItemId)
            ...
            for (g = b.next(); !g.done; g = b.next()) {
                ...
                if (!g.media) {
                    ...
                    l && l.media ? g.media = l.media : k == a.currentItemId && a.media && (g.media = a.media)
                }
                k = e;
                l = k.push;
                var q = void 0
    ...
    var V = function() {
      ...
      , W = function(a, b, c, d) {
        c && mb(a.K, c);
        void 0 !== d ? b.sequenceNumber = d : (b.sequenceNumber = a.h,
        a.h = (a.h + 1) % 9007199254740992);
        d = ob(a.A, b);
        c && d && (a = nb(a.K, b.sequenceNumber)) && (b = new chrome.cast.Error(chrome.cast.C.INVALID_PARAMETER,d),
        (a = a.g) && a(b))
    };
    V.prototype.initialize = function(a, b) {
        ...
        E = this;
        this.g = a;
        a.invisibleSender || (a = new PresentationRequest(X(this)),
        a.getAvailability().then(function(d) {
            d.onchange = function() {
                c.ja = !!d.value;
        ...
        a.reconnect(chrome.cast.Ia).then(function(d) {
            Y(c, d)
        }, function() {}));
        b && b(void 0)
    }
    ...
    var Y = function(a, b, c) {
        ...
        b.onclose = function(d) {
            ...
            case "closed":
                ...
                break;
            case "error":
                c && (d = new chrome.cast.Error(chrome.cast.C.SESSION_ERROR),
                c && c(d))
            }
        }
        ;
      ...
      , Mb = function(a) {
        var b = Z;
        Kb.has(a.type) && b.ja && (b.m ? (a.sessionId = b.m,
        Lb(b, null, a.type, a, function() {}, function() {})) : b.Va.A(X(b, void 0, "urn:x-cast:com.google.cast.media", a)))
    };
    ...
    V.prototype.requestSession = function(a, b, c) {
        var d = this;
        this.j ? Ib(b) : (c = X(this, c),
        this.j = a,
        (new PresentationRequest(c)).start().then(function(e) {
            Y(d, e, b)
        }).catch(function(e) {
            d.j = null;
    ...
    var X = function(a, b, c, d) {
        ...
        var k = b.dialRequest;
        k && (e = k.appName,
        (g = k.launchParameter) && !g.match(Nb) && (g = Gb(g)));
        var l = [];
        l.push({
            appId: b.appId,
    ...
    var Lb = function(a, b, c, d, e, g, k) {
        d.type = c;
        null != b && (d.mediaSessionId = b.mediaSessionId,
        d.sessionId = b.sessionId);
        a.Ea(d, function(l) {
            l.status && 1 == l.status.length ? e && e(l.status[0]) : (l = new chrome.cast.Error(chrome.cast.C.SESSION_ERROR),
            g && g(l))
        }, g, k)
    };
    f = V.prototype;
    ...
    var Jb = function(a, b) {
        if (a.m) {
            ...
            ub(a.H, c, b) && (a.u.delete(c),
            a.I.delete(c),
            b = a.B.get(c)) && (a.B.delete(c),
            G(b.s(), function(e) {
                e(d)
            }))
        }
    ...
    V.prototype.onMessage = function(a) {
        ...
        if (b = nb(this.K, a.sequenceNumber))
        ...
        if (b = a.message)
            ...
            case "new_session":
                this.m = b.sessionId;
                this.j ? (this.j(b),
                this.j = null) : this.g && this.g.sessionListener(b);
                break;
            case "update_session":
                Qb(this, b);
                break;
    ...
    ;
    "complete" == document.readyState ? chrome.cast.ea() : (window.addEventListener("load", chrome.cast.ea, !1),
