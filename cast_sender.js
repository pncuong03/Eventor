...
*/
    ...
    var v = function(a, b) {
        a = a.split("%s");
        for (var e = "", c = a.length - 1, g = 0; g < c; g++)
            e += a[g] + (g < b.length ? b[g] : "%s");
        u.call(this, e + a[c])
    };
    r(v, u);
    ...
    var B = function() {
      ...
      , E = function(a, b, e) {
        ...
        if (void 0 === x)
            if (b = null,
            (e = m.trustedTypes) && e.createPolicy) {
                try {
        ...
        a instanceof A && a.constructor === A ? d = a.g : (d = typeof a,
        w("expected object of type TrustedResourceUrl, got '" + a + "' of type " + ("object" != d ? d : a ? Array.isArray(a) ? "array" : d : "null")),
        d = "type_error:TrustedResourceUrl");
        c.src = d;
        (d = c.ownerDocument && c.ownerDocument.defaultView) && d != m ? d = q(d.document) : (null === p && (p = q(m.document)),
        d = p);
    ...
    } else if (!window.chrome || !window.navigator.presentation || 0 <= window.navigator.userAgent.indexOf("Edge"))
        G();
    else if (89 <= B()) {
        K();
